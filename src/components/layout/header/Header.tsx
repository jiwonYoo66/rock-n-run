        ...
        <Wrapper>
            ...
            <TopHeader>
                <HeaderContainer $padding="0 16px">
                    {/* 공지 */}
                    <TextBanner>
                        락앤런 컴퍼니에 오신 것을 환영합니다. 지금 장수 쿨밸리
                        레이스 참가 신청 모집이 진행중에 있습니다. 추첨을 통해
                        진행되며 추첨 내용은 추후 공지됩니다. 많은 관심
                        부탁드립니다.
                    </TextBanner>
                    {/* 상단 메뉴 */}
                    <TopMenu>
                        <YellowMenu>
                            <YellowLink
                                href={`/${paths.TOURNAMENT}/${paths.RESULT}`}
                            >
                                대회결과
                                <Image
                                    width={16}
                        ...
                        <BlackMenu>
                            <BlackLink href={`/${paths.MYINFO}`}>
                                내정보
                            </BlackLink>
                            <BlackLink href={`/${paths.LOGIN}`}>
                                로그인
                            </BlackLink>
                        </BlackMenu>
                    </TopMenu>
